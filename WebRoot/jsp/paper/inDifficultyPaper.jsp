...
$(document).ready(function(){
	localStorage.preUrl = "${pageContext.request.contextPath}/paper/inCommonPaper";
	...
	$('#datalist').datagrid({
		...
		columns:[[
		      ...
		      {field:'NAME_C',title:'课程名称',width:60,align:'left',sortable:true},
	          ...
	          {field:'opration',title:'操作',width:120,align:'center',formatter:function(value,row,index){
	        	  var s1 = '<a href="javascript:void(0)" class="editcls1" onclick="editExamInfo(' + row.QCOUNT + ', ' + row.CID + ', 4)"></a>';
	    ...
	    onLoadSuccess:function(data){
	    	$('.editcls1').linkbutton({text:'按难度组卷',plain:true});
