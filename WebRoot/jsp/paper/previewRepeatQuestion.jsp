		...
		<table class="courseTable" width="100%" >			
			<c:choose>
				<c:when test="${mainQuestion.ismain eq 1}">
					...
					<tr>
						<td align='right' style="width:10%;">附件：</td>
						<td style="width:90%;">
...
function getQuestionDetail(qid,mqid,cid,ismain,qtiscon,eid,number,edit){
	var url = "${pageContext.request.contextPath}/paper/previewQuestion?qid="+qid+"&mqid="+mqid+"&c_id="+cid+"&isMain="+ismain+"&iscon="+qtiscon+"&eid="+eid+"&c_ids="+cids+"&number="+number+"&edit="+edit;
