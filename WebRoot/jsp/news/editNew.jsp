	...
	<form id="newsForm" method="post">
		...
		<table style="margin-top:20px; width: 100%">
			<tr>
				...
				<td style="width:90%; text-align:left;">
					<div class="radio-group">
						<input type="radio" id="type0" name="type" value="0" ${news.type eq 0 ? 'checked="checked"' : ''} />
						<label for="type0">公告</label>
						<input type="radio" id="type1" name="type" value="1"${news.type eq 1 ? 'checked="checked"' : ''} />
			...
			<tr>
				...
				<td style="width:90%;text-align: left;">
					<input id="title" name="title" style="width:100%;" value="${news.title }"/>
				</td>
			</tr>
			<tr>
				<td style="width:10%;text-align: left;">内容:</td>
				<td style="width:90%;text-align: left;">
					<script id="content" name="content" type="text/plain" style="width:100%;height:300px;">${news.content }</script> 
				</td>
			</tr>
		</table>
	</form>
...
<div style="width: 100%; height: 40px; text-align: center;">
	<a class="easyui-linkbutton" data-options="iconCls:'icon-save'" href="javascript:void(0);" onclick="editNew()">保存</a>&nbsp;
</div>
...
function editNew(){
	$('#newsForm').form('submit', {
	    url:'${pageContext.request.contextPath}/news/editNew',
	    onSubmit: function(){
