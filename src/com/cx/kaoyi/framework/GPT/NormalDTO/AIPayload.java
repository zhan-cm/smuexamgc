package com.cx.kaoyi.framework.GPT.NormalDTO;

import com.alibaba.fastjson2.annotation.JSONField;
import com.cx.kaoyi.framework.GPT.generateDTO.payload.ResponseFormat;
...
public class AIPayload {
    ...
    private int maxCompletionTokens = 2048; //最大输出token数，默认是1024，deepseek最大是8192，但是不知道为啥百度限制最大4096，文心4.5最大2048
