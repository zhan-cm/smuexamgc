...
<Relationships
    ...
    <#if (allImgList??) && (allImgList?size > 0)>
        <#list allImgList as img>
            <Relationship Id="rId${img?index + 23}" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/image" Target="media/image${img?index + 1}.png"/>
        </#list>
    </#if>
</Relationships>